...
frappe.ui.form.on("Payroll Entry", {
  ...
  add_bank_entry_button: function (frm) {
    frappe.call({
      method: ///home/mim/alfouad/apps/attendance/attendance/attendance/doctype/payroll_entry/payroll_entry.py
        "attendance.attendance.doctype.payroll_entry.payroll_entry.payroll_entry_has_bank_entries",
      args: {
        name: frm.doc.name,
      },
      callback: function (r) {
